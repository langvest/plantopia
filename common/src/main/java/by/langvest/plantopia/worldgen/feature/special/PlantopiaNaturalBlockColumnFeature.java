...
public class PlantopiaNaturalBlockColumnFeature extends Feature<BlockColumnConfiguration> {
    ...
    public static boolean place(
        ...
        int flags,
        List<BlockColumnConfiguration.Layer> layers
    ) {
        return place(
            level,
            pos,
    ...
    @Contract(pure = true)
    public static @NotNull LayerHeightProvider simpleHeightProvider(List<BlockColumnConfiguration.Layer> layers) {
        return (level, pos, random, layerIndex, totalHeight) -> layers.get(layerIndex).height().sample(random);
    }

    @Contract(pure = true)
    public static @NotNull LayerStateProvider simpleStateProvider(List<BlockColumnConfiguration.Layer> layers) {
    ...
    public static boolean isFavorablePos(BlockState state, WorldGenLevel level, BlockPos pos, Direction direction) {
        return isFavorablePos(state, level, pos, direction, null);
    }

    public static boolean isFavorablePos(BlockState state, WorldGenLevel level, BlockPos pos, Direction direction, @Nullable BlockPredicate allowedPlacement) {
