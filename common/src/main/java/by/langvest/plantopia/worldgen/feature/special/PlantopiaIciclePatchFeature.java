...
public class PlantopiaIciclePatchFeature extends Feature<PlantopiaIciclePatchConfiguration> {
    ...
    @Override
    public boolean place(FeaturePlaceContext<PlantopiaIciclePatchConfiguration> context) {
    ...
    private boolean placeColumn(WorldGenLevel level, BlockPos columnBasePos, Direction growthDirection, int height, PlantopiaIciclePatchConfiguration config, RandomSource random) {
        if (height <= 0) {
            return false;
        }
    ...
    @Nullable
    private PlacementInfo findPlacement(WorldGenLevel level, BlockPos originPos, PlantopiaIciclePatchConfiguration config, RandomSource random) {
