...
public class PlantopiaRadialPatchFeature extends Feature<PlantopiaRadialPatchConfiguration> {
    ...
    @Override
    public boolean place(FeaturePlaceContext<PlantopiaRadialPatchConfiguration> context) {
    ...
    @Nullable
    private BlockPos findYPos(FeaturePlaceContext<PlantopiaRadialPatchConfiguration> context, BlockPos xzPos, int ySpread) {
        var config = context.config();
        var random = context.random();
        var level = context.level();
        var centerPos = context.origin();
    ...
    private @NotNull BlockPos findXZPos(FeaturePlaceContext<PlantopiaRadialPatchConfiguration> context, int xzSpread) {
        var config = context.config();
        var random = context.random();
        var centerPos = context.origin();
    ...
    @Nullable
    private PlantopiaBlockPlacer selectWeightedBlockPlacer(PlantopiaRadialPatchConfiguration config, RandomSource random) {
