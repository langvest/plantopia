...
public class PlantopiaBiomeDeclaration {
    ...
    private final @Nullable Float downfall;
    private final List<RegistryObject<PlantopiaRegion>> regions;

    private final Function<Biome.BiomeBuilder, Biome.BiomeBuilder> modifyBiome;
    private final Function<BiomeSpecialEffects.Builder, BiomeSpecialEffects.Builder> modifySpecialEffects;
    private final Function<BiomeGenerationSettings.Builder, BiomeGenerationSettings.Builder> modifyGeneration;
    private final Function<MobSpawnSettings.Builder, MobSpawnSettings.Builder> modifySpawn;

    @Contract(pure = true)
    protected PlantopiaBiomeDeclaration(String name, Builder builder) {
        this.name = name;
    ...
    public Biome getBiome(BootstapContext<Biome> context) {
    ...
    public static class Builder {
        ...
        private final List<RegistryObject<PlantopiaRegion>> regions = Lists.newArrayList();
        ...
        public Builder applyBiome(Consumer<Biome.BiomeBuilder> consumer) {
        ...
        public Builder applySpecialEffects(Consumer<BiomeSpecialEffects.Builder> consumer) {
        ...
        public Builder applyGeneration(Consumer<BiomeGenerationSettings.Builder> consumer) {
        ...
        public Builder applySpawn(Consumer<MobSpawnSettings.Builder> consumer) {
