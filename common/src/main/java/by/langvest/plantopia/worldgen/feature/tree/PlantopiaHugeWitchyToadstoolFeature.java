...
public class PlantopiaHugeWitchyToadstoolFeature extends AbstractHugeMushroomFeature {
    ...
    @Override
    protected void placeTrunk(LevelAccessor level, RandomSource random, BlockPos pos, HugeMushroomFeatureConfiguration config, int totalMushroomHeight, BlockPos.MutableBlockPos mutablePos) {
    ...
    @Override
    protected void makeCap(LevelAccessor level, RandomSource random, BlockPos basePos, int totalMushroomHeight, BlockPos.MutableBlockPos mutablePos, HugeMushroomFeatureConfiguration config) {
    ...
    private void placeBlock(LevelAccessor level, BlockPos pos, RandomSource random, BlockStateProvider provider) {
