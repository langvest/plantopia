...
public class PlantopiaIcicleClusterFeature extends Feature<PlantopiaIcicleClusterConfiguration> {
    ...
    @Override
    public boolean place(FeaturePlaceContext<PlantopiaIcicleClusterConfiguration> context) {
    ...
    private void placeColumn(WorldGenLevel level, RandomSource random, BlockPos pos, int x, int z, double chance, int height, float density, PlantopiaIcicleClusterConfiguration config) {
    ...
    private int getIcicleHeight(RandomSource random, int x, int z, float chance, int height, PlantopiaIcicleClusterConfiguration config) {
    ...
    private double getChanceOfStalagmiteOrStalactite(int xRadius, int zRadius, int x, int z, PlantopiaIcicleClusterConfiguration config) {
