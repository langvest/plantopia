...
public class PlantopiaVegetationPatchFeature extends Feature<PlantopiaVegetationPatchConfiguration> {
    ...
    @Override
    public boolean place(FeaturePlaceContext<PlantopiaVegetationPatchConfiguration> context) {
    ...
    protected Set<BlockPos> placeGroundPatch(WorldGenLevel level, PlantopiaVegetationPatchConfiguration config, RandomSource random, BlockPos origin, int xRadius, int zRadius) {
    ...
    private void tryPlacingColumn(WorldGenLevel level, PlantopiaVegetationPatchConfiguration config, RandomSource random, BlockPos origin, int dx, int dz, Set<BlockPos> placedPositions) {
    ...
    private void findSuitableSurface(WorldGenLevel level, BlockPos.MutableBlockPos mutablePos, int verticalRange, net.minecraft.core.Direction surfaceDirection) {
    ...
    protected void distributeVegetation(FeaturePlaceContext<PlantopiaVegetationPatchConfiguration> context, WorldGenLevel level, PlantopiaVegetationPatchConfiguration config, RandomSource random, Set<BlockPos> groundPositions) {
    ...
    protected void placeSingleVegetation(WorldGenLevel level, PlantopiaVegetationPatchConfiguration config, ChunkGenerator chunkGenerator, RandomSource random, BlockPos groundPos) {
