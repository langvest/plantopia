...
public class PlantopiaCactusColumnFeature extends Feature<BlockColumnConfiguration> {
    ...
    public static boolean placeCactusBlock(LevelAccessor level, BlockPos pos, BlockState state, int flags, RandomSource random, boolean allowTopDecoration) {
    ...
    public static Block getRandomTinyCactus(RandomSource random) {
