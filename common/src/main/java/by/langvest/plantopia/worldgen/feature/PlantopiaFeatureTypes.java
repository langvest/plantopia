...
public class PlantopiaFeatureTypes {
    ...
    public static final RegistryObject<PlantopiaFirTreeFeature> FIR_TREE = registerFeatureType("fir_tree", () -> new PlantopiaFirTreeFeature(PlantopiaFirTreeConfiguration.CODEC));
