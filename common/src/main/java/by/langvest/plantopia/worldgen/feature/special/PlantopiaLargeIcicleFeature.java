...
public class PlantopiaLargeIcicleFeature extends Feature<PlantopiaLargeIcicleConfiguration> {
    ...
    @Override
    public boolean place(FeaturePlaceContext<PlantopiaLargeIcicleConfiguration> context) {
    ...
    private static @NotNull LargeIcicle makeIcicle(BlockPos root, boolean pointingUp, RandomSource random, int radius, FloatProvider bluntnessBase, FloatProvider scaleBase) {
    ...
    private static final class LargeIcicle {
        ...
        boolean isSuitableForWind(PlantopiaLargeIcicleConfiguration config) {
