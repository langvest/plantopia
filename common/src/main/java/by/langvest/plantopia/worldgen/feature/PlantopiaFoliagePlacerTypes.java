...
public class PlantopiaFoliagePlacerTypes {
    ...
    public static final RegistryObject<FoliagePlacerType<PlantopiaRandomSelectorFoliagePlacer>> RANDOM_SELECTOR_FOLIAGE_PLACER = registerFoliagePlacerType("random_selector_foliage_placer", () -> new FoliagePlacerType<>(PlantopiaRandomSelectorFoliagePlacer.CODEC));
    public static final RegistryObject<FoliagePlacerType<PlantopiaBlobPalmFoliagePlacer>> BLOB_PALM_FOLIAGE_PLACER = registerFoliagePlacerType("blob_palm_foliage_placer", () -> new FoliagePlacerType<>(PlantopiaBlobPalmFoliagePlacer.CODEC));
    public static final RegistryObject<FoliagePlacerType<PlantopiaLushPalmFoliagePlacer>> LUSH_PALM_FOLIAGE_PLACER = registerFoliagePlacerType("lush_palm_foliage_placer", () -> new FoliagePlacerType<>(PlantopiaLushPalmFoliagePlacer.CODEC));
