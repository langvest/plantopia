...
public class PlantopiaFirKit extends PlantopiaAbstractTreeKit {
    ...
    public PlantopiaFirKit(
        ...
        this.leaves = PlantopiaBlocks.registerBlock(baseName + "_leaves", LeavesBlock::new, config.applyBlockMeta(MetaProperties.of(MetaType.LEAVES).mapColor(MapColor.WOOD)));
