...
import by.langvest.plantopia.kit.special.PlantopiaTreeTimberKit;
...
public class PlantopiaMapleKit extends PlantopiaAbstractTreeKit {
    ...
    public final PlantopiaTreeTimberKit timber;
    ...
    public PlantopiaMapleKit(
        ...
        this.timber = new PlantopiaTreeTimberKit(baseName, trunk.log, trunk.strippedLog, trunk.wood, trunk.strippedWood, config);
