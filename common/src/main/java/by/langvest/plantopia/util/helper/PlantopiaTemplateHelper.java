...
public final class PlantopiaTemplateHelper {
    ...
    @Contract(pure = true)
    public static @NotNull String getCreativeModeTabTitleKey(ResourceLocation identifier) {
    ...
    @Contract(pure = true)
    public static @NotNull String getDamageTypeTitleKey(String messageId, @Nullable String qualifier) {
    ...
    @Contract(pure = true)
    public static @NotNull String getEntityTypeTitleKey(ResourceLocation identifier) {
    ...
    @Contract(pure = true)
    public static @NotNull String getBiomeTitleKey(ResourceLocation identifier) {
