...
public final class PlantopiaResourceHelper {
    ...
    public static @NotNull ResourceLocation locationFrom(String namespace, String... path) {
        return new ResourceLocation(namespace, String.join("/", path));
    }
    ...
    public static @NotNull String nameOf(Object object) {
        return locationOf(object).getPath();
    }

    public static @NotNull String namespaceOf(Object object) {
    ...
    public static int compareById(Object o1, Object o2) {
