...
public class PlantopiaBlocks {
    ...
    public static final RegistryObject<Block> FLUFFY_GRASS = registerBlock("fluffy_grass", properties -> new PlantopiaShortBushBlock(properties, supposeBlock("tall_fluffy_grass")), MetaProperties.of(MetaType.TINY_GRASS).grassTint().customModel());
    public static final RegistryObject<Block> TALL_FLUFFY_GRASS = registerBlock("tall_fluffy_grass", properties -> new PlantopiaTallBushBlock(properties, FLUFFY_GRASS), MetaProperties.of(MetaType.SMALL_GRASS).grassTint().customModel().notPottable());
    ...
    public static final RegistryObject<Block> FIREWEED = registerBlock("fireweed", PlantopiaHerbBlock::new, MetaProperties.of(MetaType.HERB));
    public static final RegistryObject<Block> CHICORY = registerBlock("chicory", PlantopiaHerbBlock::new, MetaProperties.of(MetaType.HERB));
    public static final RegistryObject<Block> CARROTWEED = registerBlock("carrotweed", PlantopiaHerbBlock::new, MetaProperties.of(MetaType.HERB).customDrop());
    public static final RegistryObject<Block> TANSY = registerBlock("tansy", PlantopiaHerbBlock::new, MetaProperties.of(MetaType.HERB));
    ...
    public static final RegistryObject<Block> LAVENDER = registerBlock("lavender", properties -> new PlantopiaLavenderBlock(() -> MobEffects.REGENERATION, 5, properties), MetaProperties.of(MetaType.SMALL_FLOWER).color(DyeColor.PURPLE));
    public static final RegistryObject<Block> VIOLET = registerBlock("violet", properties -> new PlantopiaShortFlowersBlock(() -> MobEffects.MOVEMENT_SLOWDOWN, 10, properties), MetaProperties.of(MetaType.SMALL_FLOWER).color(DyeColor.PURPLE));
    ...
    public static final RegistryObject<Block> RED_WILDFLOWERS = registerBlock("red_wildflowers", properties -> new PlantopiaShortFlowersBlock(() -> MobEffects.WEAKNESS, 6, properties), MetaProperties.of(MetaType.WILDFLOWERS).color(DyeColor.RED));
    public static final RegistryObject<Block> ORANGE_WILDFLOWERS = registerBlock("orange_wildflowers", properties -> new PlantopiaShortFlowersBlock(() -> MobEffects.WEAKNESS, 6, properties), MetaProperties.of(MetaType.WILDFLOWERS).color(DyeColor.ORANGE));
    public static final RegistryObject<Block> YELLOW_WILDFLOWERS = registerBlock("yellow_wildflowers", properties -> new PlantopiaShortFlowersBlock(() -> MobEffects.WEAKNESS, 6, properties), MetaProperties.of(MetaType.WILDFLOWERS).color(DyeColor.YELLOW));
    public static final RegistryObject<Block> WHITE_WILDFLOWERS = registerBlock("white_wildflowers", properties -> new PlantopiaShortFlowersBlock(() -> MobEffects.WEAKNESS, 6, properties), MetaProperties.of(MetaType.WILDFLOWERS).color(DyeColor.LIGHT_GRAY));
    public static final RegistryObject<Block> PINK_WILDFLOWERS = registerBlock("pink_wildflowers", properties -> new PlantopiaShortFlowersBlock(() -> MobEffects.WEAKNESS, 6, properties), MetaProperties.of(MetaType.WILDFLOWERS).color(DyeColor.PINK));
    public static final RegistryObject<Block> PURPLE_WILDFLOWERS = registerBlock("purple_wildflowers", properties -> new PlantopiaShortFlowersBlock(() -> MobEffects.WEAKNESS, 6, properties), MetaProperties.of(MetaType.WILDFLOWERS).color(DyeColor.PURPLE));
