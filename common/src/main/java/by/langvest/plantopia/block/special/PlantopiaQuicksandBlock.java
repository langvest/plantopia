...
public class PlantopiaQuicksandBlock extends SandBlock implements BucketPickup {
    ...
    public static boolean isEntityDrownsInQuicksand(Entity entity) {
        var level = Objects.requireNonNull(entity.level());
    ...
    public static boolean isEntityImmuneToQuicksand(Entity entity) {
