...
public class PlantopiaCobblestoneShardPetBlockEntityRenderer implements BlockEntityRenderer<PlantopiaCobblestoneShardPetBlockEntity> {
    ...
    @Override
    public void render(PlantopiaCobblestoneShardPetBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
