...
public class PlantopiaFrozenReedBlockEntityRenderer implements BlockEntityRenderer<PlantopiaFrozenReedBlockEntity> {
    ...
    @Override
    public void render(PlantopiaFrozenReedBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
