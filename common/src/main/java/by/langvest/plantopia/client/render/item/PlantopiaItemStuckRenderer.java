...
public class PlantopiaItemStuckRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private void renderCollectionItem(List<ItemLike> collection, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
