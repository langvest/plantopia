...
public class PlantopiaSeaHangingMossClusterFeature extends Feature<PlantopiaSeaHangingMossClusterConfiguration> {
    ...
    @Override
    public boolean place(@NotNull FeaturePlaceContext<PlantopiaSeaHangingMossClusterConfiguration> context) {
    ...
    @Nullable
    private BlockPos findCeiling(WorldGenLevel level, @NotNull BlockPos pos, int ySpread, @NotNull PlantopiaSeaHangingMossClusterConfiguration config) {
    ...
    private boolean placeBlob(WorldGenLevel level, @NotNull BlockPos pos, int depth, BlockPredicate allowedPlacement, @NotNull RandomSource random) {
        var mutablePos = pos.mutable();
        boolean successfullyPlaced = false;
    ...
    @Nullable
    private PlacementInfo findPlacement(@NotNull WorldGenLevel level, @NotNull BlockPos origin, @NotNull PlantopiaSeaHangingMossClusterConfiguration config, @NotNull RandomSource random) {
