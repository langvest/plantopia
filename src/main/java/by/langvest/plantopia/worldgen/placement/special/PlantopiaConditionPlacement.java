...
public class PlantopiaConditionPlacement extends PlacementModifier {
    ...
    private @NotNull Stream<BlockPos> resolvePlacement(@NotNull List<PlacementModifier> placements, @NotNull PlacementContext context, @NotNull RandomSource random, @NotNull BlockPos pos) {
