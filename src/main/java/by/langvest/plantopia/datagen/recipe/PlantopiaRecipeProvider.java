...
import by.langvest.plantopia.datagen.recipe.builder.PlantopiaLuckyDaisyDyeRecipeBuilder;
...
public class PlantopiaRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private static void setConsumer(@NotNull Consumer<FinishedRecipe> consumer) {
        PlantopiaRecipeProvider.consumer = consumer;
    }
    ...
    public static void luckyDaisyDye(@NotNull PlantopiaBlockMeta blockMeta) {
        ...
        PlantopiaLuckyDaisyDyeRecipeBuilder.of(Ingredient.of(daisyItem), colorDye)
            ...
            .save(consumer, plantopia(getConversionRecipeName(colorDye, daisyItem)));
    }
