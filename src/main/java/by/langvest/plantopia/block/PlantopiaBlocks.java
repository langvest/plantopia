...
public class PlantopiaBlocks {
	...
	public static final RegistryObject<Block> RED_FLOWERING_LILY_PAD = registerBlock("red_flowering_lily_pad", () -> new PlantopiaFloweringLilyPadBlock(PlantopiaItems.RED_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().lilyPadTint());
	public static final RegistryObject<Block> YELLOW_FLOWERING_LILY_PAD = registerBlock("yellow_flowering_lily_pad", () -> new PlantopiaFloweringLilyPadBlock(PlantopiaItems.YELLOW_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().lilyPadTint());
	public static final RegistryObject<Block> WHITE_FLOWERING_LILY_PAD = registerBlock("white_flowering_lily_pad", () -> new PlantopiaFloweringLilyPadBlock(PlantopiaItems.WHITE_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().lilyPadTint());
	public static final RegistryObject<Block> PINK_FLOWERING_LILY_PAD = registerBlock("pink_flowering_lily_pad", () -> new PlantopiaFloweringLilyPadBlock(PlantopiaItems.PINK_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().lilyPadTint());
	public static final RegistryObject<Block> RED_FLOWERING_SMALL_PLATTERLEAF = registerBlock("red_flowering_small_platterleaf", () -> new PlantopiaFloweringSmallPlatterleafBlock(PlantopiaItems.RED_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem());
	public static final RegistryObject<Block> YELLOW_FLOWERING_SMALL_PLATTERLEAF = registerBlock("yellow_flowering_small_platterleaf", () -> new PlantopiaFloweringSmallPlatterleafBlock(PlantopiaItems.YELLOW_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem());
	public static final RegistryObject<Block> WHITE_FLOWERING_SMALL_PLATTERLEAF = registerBlock("white_flowering_small_platterleaf", () -> new PlantopiaFloweringSmallPlatterleafBlock(PlantopiaItems.WHITE_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem());
	public static final RegistryObject<Block> PINK_FLOWERING_SMALL_PLATTERLEAF = registerBlock("pink_flowering_small_platterleaf", () -> new PlantopiaFloweringSmallPlatterleafBlock(PlantopiaItems.PINK_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem());
