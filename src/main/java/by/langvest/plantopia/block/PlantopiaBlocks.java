...
public class PlantopiaBlocks {
	...
	public static final RegistryObject<Block> WATERGRASS = registerBlock("watergrass", () -> new PlantopiaWaterloggedDoublePlantBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.PLANT)), MetaProperties.copy(MetaType.WATER_PLANT).order(PlantopiaOrderType.WET_PLANT).doubleHigh().customDrop().customModel().grassTint());
	...
	public static final RegistryObject<Block> SEA_OATS = registerBlock("sea_oats", () -> new PlantopiaSeaOatsBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.SAND)), MetaProperties.copy(MetaType.PLANT).doubleHigh().dropSelfByShears());
