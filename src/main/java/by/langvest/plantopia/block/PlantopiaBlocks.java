...
public class PlantopiaBlocks {
	...
	public static final RegistryObject<Block> WHITE_CLOVER_BLOSSOM = registerBlock("white_clover_blossom", () -> new PlantopiaCloverBlossomBlock(() -> MobEffects.LUCK, 14, Properties.copy(Blocks.DANDELION).offsetType(OffsetType.XYZ).sound(SoundType.AZALEA)), MetaProperties.copy(MetaType.FLOWER).order(PlantopiaOrderType.CLOVER).customModel().grassTint().dye(Items.LIGHT_GRAY_DYE));
	public static final RegistryObject<Block> PINK_CLOVER_BLOSSOM = registerBlock("pink_clover_blossom", () -> new PlantopiaCloverBlossomBlock(() -> MobEffects.LUCK, 14, Properties.copy(PlantopiaBlocks.WHITE_CLOVER_BLOSSOM.get())), MetaProperties.copy(MetaType.FLOWER).order(PlantopiaOrderType.CLOVER).customModel().grassTint().dye(Items.PINK_DYE));
	public static final RegistryObject<Block> COBBLESTONE_SHARD = registerBlock("cobblestone_shard", () -> new PlantopiaCobblestoneShardBlock(Properties.of().strength(0.2F).sound(SoundType.DRIPSTONE_BLOCK).noOcclusion().pushReaction(PushReaction.DESTROY)), MetaProperties.copy(MetaType.STONE).customModel().customDrop().customItem());
	public static final RegistryObject<Block> MOSSY_COBBLESTONE_SHARD = registerBlock("mossy_cobblestone_shard", () -> new PlantopiaCobblestoneShardBlock(Properties.copy(PlantopiaBlocks.COBBLESTONE_SHARD.get())), MetaProperties.copy(MetaType.STONE).customModel().customDrop().customItem());
	public static final RegistryObject<Block> COBBLESTONE_SHARD_PET = registerBlock("cobblestone_shard_pet", () -> new PlantopiaCobblestoneShardPetBlock(COBBLESTONE_SHARD, Properties.copy(PlantopiaBlocks.COBBLESTONE_SHARD.get())), MetaProperties.copy(MetaType.STONE).customModel().customDrop().cutoutMippedRender().noItem());
	public static final RegistryObject<Block> MOSSY_COBBLESTONE_SHARD_PET = registerBlock("mossy_cobblestone_shard_pet", () -> new PlantopiaCobblestoneShardPetBlock(MOSSY_COBBLESTONE_SHARD, Properties.copy(PlantopiaBlocks.COBBLESTONE_SHARD.get())), MetaProperties.copy(MetaType.STONE).customModel().customDrop().cutoutMippedRender().noItem());
	...
	public static final RegistryObject<Block> RED_MALLOW = registerBlock("red_mallow", () -> new TallFlowerBlock(Properties.copy(Blocks.ROSE_BUSH)), MetaProperties.copy(MetaType.FLOWER).doubleHigh().customModel().dye(Items.RED_DYE));
	public static final RegistryObject<Block> YELLOW_MALLOW = registerBlock("yellow_mallow", () -> new TallFlowerBlock(Properties.copy(Blocks.ROSE_BUSH)), MetaProperties.copy(MetaType.FLOWER).doubleHigh().customModel().dye(Items.YELLOW_DYE));
	public static final RegistryObject<Block> WHITE_MALLOW = registerBlock("white_mallow", () -> new TallFlowerBlock(Properties.copy(Blocks.ROSE_BUSH)), MetaProperties.copy(MetaType.FLOWER).doubleHigh().customModel().dye(Items.WHITE_DYE));
	public static final RegistryObject<Block> PINK_MALLOW = registerBlock("pink_mallow", () -> new TallFlowerBlock(Properties.copy(Blocks.ROSE_BUSH)), MetaProperties.copy(MetaType.FLOWER).doubleHigh().customModel().dye(Items.PINK_DYE));
	public static final RegistryObject<Block> MAGENTA_MALLOW = registerBlock("magenta_mallow", () -> new TallFlowerBlock(Properties.copy(Blocks.ROSE_BUSH)), MetaProperties.copy(MetaType.FLOWER).doubleHigh().customModel().dye(Items.MAGENTA_DYE));
	public static final RegistryObject<Block> PURPLE_MALLOW = registerBlock("purple_mallow", () -> new TallFlowerBlock(Properties.copy(Blocks.ROSE_BUSH)), MetaProperties.copy(MetaType.FLOWER).doubleHigh().customModel().dye(Items.PURPLE_DYE));
	...
	public static final RegistryObject<Block> SWEET_FLAG = registerBlock("sweet_flag", () -> new PlantopiaWaterloggedDoublePlantBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.PLANT)), MetaProperties.copy(MetaType.WATER_PLANT).order(PlantopiaOrderType.WET_PLANT).doubleHigh().dropSelfByShears().grassTint());
	public static final RegistryObject<Block> CATTAIL = registerBlock("cattail", () -> new PlantopiaWaterloggedDoublePlantBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.PLANT)), MetaProperties.copy(MetaType.WATER_PLANT).order(PlantopiaOrderType.WET_PLANT).doubleHigh().dropSelfByShears().customModel().grassTint());
	public static final RegistryObject<Block> REEDS = registerBlock("reeds", () -> new PlantopiaReedsBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.WOOD)), MetaProperties.copy(MetaType.WATER_PLANT).doubleHigh().order(PlantopiaOrderType.WET_PLANT).dropSelfByShears());
	public static final RegistryObject<Block> TALL_REEDS = registerBlock("tall_reeds", () -> new PlantopiaTallReedsBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.WOOD)), MetaProperties.copy(MetaType.WATER_PLANT).order(PlantopiaOrderType.WET_PLANT).tripleHigh().customModel().customTint().dropSelfByShears().compostable(Compostability.PLANT_3));
	public static final RegistryObject<Block> DUNE_GRASS = registerBlock("dune_grass", () -> new PlantopiaDuneGrassBlock(Properties.copy(Blocks.GRASS).mapColor(MapColor.SAND)), MetaProperties.copy(MetaType.PLANT).dropSelfByShears().pottable());
	public static final RegistryObject<Block> TALL_DUNE_GRASS = registerBlock("tall_dune_grass", () -> new PlantopiaTallDuneGrassBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.SAND)), MetaProperties.copy(MetaType.PLANT).doubleHigh().customDrop());
	public static final RegistryObject<Block> SEA_MOSS = registerBlock("sea_moss", () -> new PlantopiaSeaMossBlock(Properties.of().randomTicks().noCollission().instabreak().sound(SoundType.WET_GRASS).pushReaction(PushReaction.DESTROY)), MetaProperties.copy(MetaType.UNDERWATER_PLANT).order(PlantopiaOrderType.WET_PLANT).customDrop().customModel());
	public static final RegistryObject<Block> SEA_MOSS_PLANT = registerBlock("sea_moss_plant", () -> new PlantopiaSeaMossPlantBlock(Properties.of().noCollission().instabreak().sound(SoundType.WET_GRASS).pushReaction(PushReaction.DESTROY)), MetaProperties.copy(MetaType.UNDERWATER_PLANT).customDrop().customModel().noItem());
	...
	public static final RegistryObject<Block> BIG_PLATTERLEAF = registerBlock("big_platterleaf", () -> new PlantopiaBigPlatterleafBlock(Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).customDrop().customModel().customItem().compostable(Compostability.PLANT_1 * 2));
	public static final RegistryObject<Block> RED_WATERLILY = registerBlock("red_waterlily", () -> new PlantopiaWaterlilyFlowerBlock(() -> MobEffects.CONFUSION, 9, Properties.copy(Blocks.LILY_PAD).sound(SoundType.CHERRY_LEAVES).noCollission()), MetaProperties.copy(MetaType.WATERLILY_FLOWER).dye(Items.RED_DYE).customItem().dropSelf().waterlilyTint());
	public static final RegistryObject<Block> YELLOW_WATERLILY = registerBlock("yellow_waterlily", () -> new PlantopiaWaterlilyFlowerBlock(() -> MobEffects.CONFUSION, 9, Properties.copy(Blocks.LILY_PAD).sound(SoundType.CHERRY_LEAVES).noCollission()), MetaProperties.copy(MetaType.WATERLILY_FLOWER).dye(Items.YELLOW_DYE).customItem().dropSelf().waterlilyTint());
	public static final RegistryObject<Block> WHITE_WATERLILY = registerBlock("white_waterlily", () -> new PlantopiaWaterlilyFlowerBlock(() -> MobEffects.CONFUSION, 9, Properties.copy(Blocks.LILY_PAD).sound(SoundType.CHERRY_LEAVES).noCollission()), MetaProperties.copy(MetaType.WATERLILY_FLOWER).dye(Items.WHITE_DYE).customItem().dropSelf().waterlilyTint());
	public static final RegistryObject<Block> PINK_WATERLILY = registerBlock("pink_waterlily", () -> new PlantopiaWaterlilyFlowerBlock(() -> MobEffects.CONFUSION, 9, Properties.copy(Blocks.LILY_PAD).sound(SoundType.CHERRY_LEAVES).noCollission()), MetaProperties.copy(MetaType.WATERLILY_FLOWER).dye(Items.PINK_DYE).customItem().dropSelf().waterlilyTint());
	public static final RegistryObject<Block> RED_FLOWERING_LILY_PAD = registerBlock("red_flowering_lily_pad", () -> new PlantopiaFloweringLilyPadBlock(RED_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().lilyPadTint().preferredByBees());
	public static final RegistryObject<Block> YELLOW_FLOWERING_LILY_PAD = registerBlock("yellow_flowering_lily_pad", () -> new PlantopiaFloweringLilyPadBlock(YELLOW_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().lilyPadTint().preferredByBees());
	public static final RegistryObject<Block> WHITE_FLOWERING_LILY_PAD = registerBlock("white_flowering_lily_pad", () -> new PlantopiaFloweringLilyPadBlock(WHITE_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().lilyPadTint().preferredByBees());
	public static final RegistryObject<Block> PINK_FLOWERING_LILY_PAD = registerBlock("pink_flowering_lily_pad", () -> new PlantopiaFloweringLilyPadBlock(PINK_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().lilyPadTint().preferredByBees());
	public static final RegistryObject<Block> RED_FLOWERING_SMALL_PLATTERLEAF = registerBlock("red_flowering_small_platterleaf", () -> new PlantopiaFloweringSmallPlatterleafBlock(RED_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().preferredByBees());
	public static final RegistryObject<Block> YELLOW_FLOWERING_SMALL_PLATTERLEAF = registerBlock("yellow_flowering_small_platterleaf", () -> new PlantopiaFloweringSmallPlatterleafBlock(YELLOW_WATERLILY, Properties.copy(Blocks.LILY_PAD)), MetaProperties.copy(MetaType.WATERLILY).noItem().preferredByBees());
	...
	public static final RegistryObject<Block> WHITE_LUCKY_DAISY = registerBlock("white_lucky_daisy", () -> new PlantopiaLuckyDaisyBlock(() -> MobEffects.REGENERATION, 12, Properties.copy(Blocks.OXEYE_DAISY).offsetType(OffsetType.XYZ).sound(SoundType.CHERRY_SAPLING)), MetaProperties.copy(MetaType.FLOWER).customModel().customDrop().customItem().dye(Items.LIGHT_GRAY_DYE));
	public static final RegistryObject<Block> PINK_LUCKY_DAISY = registerBlock("pink_lucky_daisy", () -> new PlantopiaLuckyDaisyBlock(() -> MobEffects.REGENERATION, 12, Properties.copy(PlantopiaBlocks.WHITE_LUCKY_DAISY.get())), MetaProperties.copy(MetaType.FLOWER).customModel().customDrop().customItem().dye(Items.PINK_DYE));
