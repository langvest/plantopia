...
public class PlantopiaBlocks {
	...
	public static final RegistryObject<Block> TALL_REEDS = registerBlock("tall_reeds", () -> new PlantopiaTallReedsBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.WOOD)), MetaProperties.copy(MetaType.WATER_PLANT).order(PlantopiaOrderType.EXOTIC_PLANT).tripleHigh().customModel().customTint().dropSelfByShears().compostable(Compostability.PLANT_3));
