...
public class PlantopiaBlocks {
	...
	public static final RegistryObject<Block> BUSH = registerBlock("bush", () -> new PlantopiaBushBlock(Properties.copy(Blocks.GRASS).sound(SoundType.GRASS)), MetaProperties.copy(MetaType.PLANT).customModel().foliageTint().customDrop().pottable());
