...
public class PlantopiaBlocks {
	...
	public static final RegistryObject<Block> WATERGRASS = registerBlock("watergrass", () -> new PlantopiaWatergrassBlock(Properties.copy(Blocks.TALL_GRASS).mapColor(MapColor.PLANT)), MetaProperties.copy(MetaType.PLANT).order(PlantopiaOrderType.EXOTIC_PLANT).doubleHigh().customDrop().customModel().grassTint().notTintedItem());
