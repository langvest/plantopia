...
public class PlantopiaWitchyToadstoolBlock extends MushroomBlock {
    ...
    public boolean canSurvive(@NotNull BlockState state, @NotNull LevelReader level, @NotNull BlockPos pos) {
        ...
        if (!mayPlaceOn(stateBelow, level, posBelow)) return false;

        return stateBelow.is(BlockTags.MUSHROOM_GROW_BLOCK) || stateBelow.canSustainPlant(level, posBelow, Direction.UP, this);
    }
