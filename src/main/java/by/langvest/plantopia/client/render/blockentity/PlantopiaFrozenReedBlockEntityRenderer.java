...
public class PlantopiaFrozenReedBlockEntityRenderer implements BlockEntityRenderer<PlantopiaFrozenReedBlockEntity> {
	public PlantopiaFrozenReedBlockEntityRenderer(@SuppressWarnings("unused") BlockEntityRendererProvider.Context context) {}

	@Override
	public void render(@NotNull PlantopiaFrozenReedBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource buffer, int packedLight, int packedOverlay) {
